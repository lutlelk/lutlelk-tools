...
import { deepClone, pick, omit } from '@fe-utils/object'
...
suite
  .add('@fe-utils/object/deepClone', function () {
...
suite2
  .add('@fe-utils/object/pick', function () {
...
suite3
  .add('@fe-utils/object/omit', function () {
